...
DETAILS = {
    ...
    "generation_failed": "The AI reply could not be completed. The exact cause was not recorded; ask your platform administrator to check the logs using the request ID below.",
    "model_rate_limited": "Gemini rejected the request because of a rate or quota limit (HTTP 429). Check the key's project usage and limits in Google AI Studio. This event was not automatically retried.",
    "model_unavailable": "Gemini was temporarily unavailable (HTTP 503). This event was not automatically retried.",
    "model_authorization_failed": "Gemini rejected access. Check the API key and its permissions in Integrations.",
    "gemini_not_configured": "No Gemini API key is configured. Add a key in Integrations to enable AI replies.",
